...
module.exports = composeEnv([require("@kie-tools/root-env/env")], {
  vars: varsWithName({
    JBPM_TRAVEL_AGENCY_EXTENDED_EXAMPLE__managementConsoleImage: {
  ...
  get env() {
    return {
      jbpmTravelAgencyExtendedExample: {
        kogitoManagementConsoleImage: getOrDefault(
          this.vars.JBPM_TRAVEL_AGENCY_EXTENDED_EXAMPLE__managementConsoleImage
        ),
