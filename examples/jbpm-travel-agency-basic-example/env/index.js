...
module.exports = composeEnv([require("@kie-tools/root-env/env")], {
  vars: varsWithName({
    JBPM_TRAVEL_AGENCY_BASIC_EXAMPLE__managementConsoleImage: {
  ...
  get env() {
    return {
      jbpmTravelAgencyBasicExample: {
        kogitoManagementConsoleImage: getOrDefault(this.vars.JBPM_TRAVEL_AGENCY_BASIC_EXAMPLE__managementConsoleImage),
