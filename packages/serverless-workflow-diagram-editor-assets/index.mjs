...
import * as gwtEditorMapping from "@kie-tools/serverless-workflow-diagram-editor-envelope/dist/api/GwtEditorMapping.js";

export default {
  swEditorPath: () => {
    const path = nodePath.resolve(import.meta.dirname, "dist", "sw");
  ...
  swEditorFontsPath: () => {
    const path = nodePath.resolve(import.meta.dirname, "dist", "sw", gwtEditorMapping.editors.swf.name, "fonts");
