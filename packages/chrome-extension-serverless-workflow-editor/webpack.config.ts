...
import swEditorAssets from "@kie-tools/serverless-workflow-diagram-editor-assets/index.mjs";
import webpack from "webpack";
import { createRequire } from "module";
// eslint-disable-next./env/index.jspt-eslint/ban-ts-comment
// @ts-ignore
...
const { swEditorPath, swEditorFontsPath } = swEditorAssets;
