...
import { init } from "../envelope/FormEnvelope";
import { FormFactory } from "../envelope/FormFactory";

export const FormEnvelopeView = (props: { envelopeConfig: EnvelopeDivConfig | EnvelopeIFrameConfig }) => {
  ...
  useEffect(() => {
    init({
      ...
      formFactory: new FormFactory(setView),
    });
