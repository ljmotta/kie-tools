...
import { DmnRunnerClause, DmnRunnerRule } from "../boxed";
...
export function useGrid(
  ...
  columnCache: React.RefObject<ColumnInstance[]>
) {
  ...
  const jsonSchemaBridge = useMemo(() => {
    return new DmnValidator().getBridge(schema ?? {});
  }, [schema]);
  ...
  }, [jsonSchemaBridge, previousBridge, setData]);
