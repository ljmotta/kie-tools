  ...
  return useMemo(() => {
    ...
    if (url.host === "bitbucket.org") {
      ...
      const snippetMatch = matchPath(
        { path: "/:org/workspace/snippets/:snippetId/:snippetName", caseSensitive: true },
        url.pathname
      );
      if (
        snippetMatch !== null &&
      ...
      const snippetCloneUrlMatch = matchPath(
        { path: "/snippets/:org/:snippetId/:snippetName", caseSensitive: true },
        url.pathname
      );
      if (
    ...
    if (url.host === "gist.github.com" || url.host === "gist.githubusercontent.com") {
      const gistMatch = matchPath({ path: "/:user/:gistId", caseSensitive: true }, url.pathname);
      const rawGistMatch = matchPath(
        { path: "/:user/:gistId/raw/:fileId/:fileName", caseSensitive: true },
        url.pathname
      );
      const directGistMatch = matchPath({ path: "/:gistId", caseSensitive: true }, url.pathname);
