...
export const config = async (env: any, argv: any) => {
  return merge(common(env, argv), {
    ...
    entry: {
      ...
      "dashbuilder-viewer-envelope": path.resolve(import.meta.dirname, "./envelope/DashbuilderViewerEnvelopeApp.ts"),
    },
    output: {
    ...
    plugins: [
      new CopyPlugin({
        patterns: [
          ...
          {
            from: path.resolve(import.meta.dirname, "./static/envelope/dashbuilder-viewer-envelope.html"),
