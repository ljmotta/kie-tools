...
export function ExpressionLanguageField(props: { label: string; onChange: (newLabel: string) => void }) {
  return <TextInput value={props.label} onChange={props.onChange}></TextInput>;
}

export function KieConstraintType() {
  return <></>;
}

export function LabelField(props: { label: string; onChange: (newLabel: string) => void }) {
  return <TextInput value={props.label} onChange={props.onChange}></TextInput>;
}
