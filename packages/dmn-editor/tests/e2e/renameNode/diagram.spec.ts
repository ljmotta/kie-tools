...
test.describe("Rename nodes - Diagram", () => {
  test("should rename Knowledge Source node", async ({ diagram, palette, nodes }) => {
  ...
  test("should rename Input Data node", async ({ diagram, palette, nodes }) => {
  ...
  test("should rename Group node", async ({ diagram, palette, nodes }) => {
  ...
  test("should rename Decision Service", async ({ diagram, palette, nodes }) => {
  ...
  test("should rename Decision node", async ({ diagram, palette, nodes }) => {
  ...
  test("should rename BKM node", async ({ diagram, palette, nodes }) => {
  ...
  test("should write text on Text Annotation node", async ({ diagram, palette, nodes }) => {
